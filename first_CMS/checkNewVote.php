...
$times = array("W tym momęcie", "Ponad minutę teamu", "Mniej niż godzinę temu", "Nie dalej niż dobę", "W tym tygodniu");
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "Użytkownik " . $row['imie'] . " " . $name . " wlasnie podpisał petycję <a href='/petycje/" . $row['title_url'] . ".html' title='" . $row['title'] . "'><span class='title'>" . $row['title'] . "</span></a></br>Dziękujemy!";
    }
} else {
    echo "0 results";
}
