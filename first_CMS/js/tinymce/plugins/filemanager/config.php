...
error_reporting(E_ALL ^ E_DEPRECATED ^ E_NOTICE);
	require_once($basepath . "../../../../../config.inc.php"); //laduje ustawienia z glownego configa
	...
	$mcFileManagerConfig['general.language'] = "pl"; // en, sv
	...
	// Preview options
	$mcFileManagerConfig['preview.wwwroot'] = $myRoot.'/upload'; // absolute or relative from this script path (c:/Inetpub/wwwroot).
	$mcFileManagerConfig['preview.urlprefix'] = $myHost.'/upload'; // domain name
	...
	$mcFileManagerConfig['filesystem.path'] = $myRoot.'/upload'; // absolute or relative from this script path.
	$mcFileManagerConfig['filesystem.rootpath'] = $myRoot.'/upload'; // absolute or relative from this script path.
	...
	$mcFileManagerConfig['upload.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv";
	...
	$mcFileManagerConfig['download.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv";
