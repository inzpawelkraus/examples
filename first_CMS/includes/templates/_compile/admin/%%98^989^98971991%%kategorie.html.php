<?php /* Smarty version 2.6.13, created on 2017-04-22 00:22:54
         compiled from sklep/kategorie.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'sklep/kategorie.html', 30, false),)), $this); ?>
<div id="content-header">
    <div id="breadcrumb"> <a href="/admin" title="Panel" class="tip-bottom"><i class="icon-home"></i> Panel</a> <a>Sklep</a><a class="current">Produkty</a> </div>
    <h1><?php echo $this->_tpl_vars['pageTitle']; ?>
</h1>
</div>
<div class="container-fluid">
    <div class="row-fluid">
        <a href="?action=add" title="Nowy produkt" class="btn"><i class="icon-plus"></i>   Dodaj nowy</a>
