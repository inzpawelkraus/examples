<?php /* Smarty version 2.6.13, created on 2017-04-05 12:37:07
         compiled from zmieniarka/dodaj.html */ ?>
...
"/>
                        ...
                        <!--                        <tr <?php if ($_SESSION['user']['admin'] != 1): ?>style="display:none;"<?php endif; ?>><th>Szerokość miniaturki:</th></tr>
                                                <tr <?php if ($_SESSION['user']['admin'] != 1): ?>style="display:none;"<?php endif; ?>><td><input class="text" type="text" name="width" value="<?php echo $this->_tpl_vars['opcje']['thumb_width_default']; ?>
" /><br /></td></tr>
                                                <tr <?php if ($_SESSION['user']['admin'] != 1): ?>style="display:none;"<?php endif; ?>><th>Wysokość miniaturki:</th></tr>
                                                <tr <?php if ($_SESSION['user']['admin'] != 1): ?>style="display:none;"<?php endif; ?>><td><input class="text" type="text" name="height" value="<?php echo $this->_tpl_vars['opcje']['thumb_height_default']; ?>
" /><br /></td></tr>
                                                ...
                                                <tr <?php if ($_SESSION['user']['admin'] != 1): ?>style="display:none;"<?php endif; ?>><td><input id="kadruj" type="checkbox" name="kadruj" value="1" <?php if ($_POST['kadruj']): ?>checked="true" <?php endif; ?> /></td></tr>
                                                <tr <?php if ($_SESSION['user']['admin'] != 1): ?>style="display:none;"<?php endif; ?>><th>Znak wodny:</th></tr>
                                                <tr <?php if ($_SESSION['user']['admin'] != 1): ?>style="display:none;"<?php endif; ?>><td><input id="watermark" type="checkbox" name="watermark" value="1" <?php if ($_POST['watermark']): ?>checked="true" <?php endif; ?> /></td></tr>
                                                <tr <?php if ($_SESSION['user']['admin'] != 1): ?>style="display:none;"<?php endif; ?>><th>Plik znaku wodnego:</th></tr>
                                                <tr <?php if ($_SESSION['user']['admin'] != 1): ?>style="display:none;"<?php endif; ?>><td><input class="text" type="text" name="watermark_file" value="<?php echo $_POST['watermark_file']; ?>
" /></td></tr>
                                                <tr <?php if ($_SESSION['user']['admin'] != 1): ?>style="display:none;"<?php endif; ?>><th>Pozycja X znaku wodnego:</th></tr>
                                                <tr <?php if ($_SESSION['user']['admin'] != 1): ?>style="display:none;"<?php endif; ?>><td><input class="text" type="text" name="watermark_x" value="<?php echo $_POST['watermark_x']; ?>
" /></td></tr>
                                                <tr <?php if ($_SESSION['user']['admin'] != 1): ?>style="display:none;"<?php endif; ?>><th>Pozycja Y znaku wodnego:</th></tr>
                                                <tr <?php if ($_SESSION['user']['admin'] != 1): ?>style="display:none;"<?php endif; ?>><td><input class="text" type="text" name="watermark_y" value="<?php echo $_POST['watermark_y']; ?>
" /></td></tr>
                                                ...
                                                <tr <?php if ($_SESSION['user']['admin'] != 1): ?>style="display:none;"<?php endif; ?>><td><select size="1" name="watermark_position">
                                                            <option value="1" <?php if ($_POST['watermark_position'] == 1): ?>selected<?php endif; ?>>lewa góra</option>
                                                            <option value="2" <?php if ($_POST['watermark_position'] == 2): ?>selected<?php endif; ?>>prawa góra</option>
                                                            <option value="3" <?php if ($_POST['watermark_position'] == 3): ?>selected<?php endif; ?>>lewa dół</option>
                                                            <option value="4" <?php if ($_POST['watermark_position'] == 4): ?>selected<?php endif; ?>>prawa dół</option>
                                                        </select></td></tr>-->
                        ...
                        <div class="control-group">
                            <div class="controls">
                                ...
                                <label>
                                    ...
                                    Pokazuj slider w serwisie</label>
<!--                                <label>
...
" name="content[<?php echo $this->_tpl_vars['JEZYK'][$this->_sections['j4']['index']]['id']; ?>
                        ...
                        <div class="form-actions">
                            <input class="btn btn-success" type="submit" name="action" value="Dodaj slider" />
