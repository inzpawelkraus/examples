...
?>
	<a <?php if ($this->_tpl_vars['menu_selected'] == $this->_tpl_vars['mb'][$this->_sections['mb']['index']]['url']): ?>class="selected"<?php endif; ?> href="<?php echo $this->_tpl_vars['mb'][$this->_sections['mb']['index']]['url']; ?>
...
" <?php if ($this->_tpl_vars['mb'][$this->_sections['mb']['index']]['target'] == 1): ?>target="_blank"<?php endif; ?>><?php echo $this->_tpl_vars['mb'][$this->_sections['mb']['index']]['name']; ?>
	...
	<?php if (! $this->_sections['mb']['last']): ?> | <?php endif;  endfor; endif; ?>