<?php /* Smarty version 2.6.13, created on 2017-03-22 10:38:27
...
/stylesheets/swiper.min.css"/>
        <link href="<?php echo $this->_tpl_vars['TPL_URL']; ?>
/icon/apple-touch-icon-48-precomposed.png" rel="apple-touch-icon-precomposed" sizes="48x48"/>
        <link href="<?php echo $this->_tpl_vars['TPL_URL']; ?>
/icon/apple-touch-icon-32-precomposed.png" rel="apple-touch-icon-precomposed"/>
        <link href="<?php echo $this->_tpl_vars['TPL_URL']; ?>
/icon/favicon.png" rel="shortcut icon"/>
                ...
                <div class="nav-wrap">
                    ...
                    <nav id="mainnav" class="mainnav">
                        <ul class="menu"> 
                            ...
                            <li class="sub-parent"><a href="blog.html">Blog </a>
                                <ul class="submenu right-sub-menu">
                                    ...
                                    <li><a href="blog-grid.html">Blog Grid</a>
                                        <ul class="submenu">
                                            <li><a href="blog-grid-left_sidebar.html">Blog Grid Sidebar Left</a></li>
                                            <li><a href="blog-grid-right_sidebar.html">Blog Grid Sidebar Right</a></li>
                                        </ul>                                    
                                    </li>
                                    ...
                                    <li><a href="blog-v2.html">Blog Version 2</a>
                                        <ul class="submenu">
                                            <li><a href="blog-v2-left_sidebar.html">Blog V2  Sidebar Left</a></li>
                                            <li><a href="blog-v2-right_sidebar.html">Blog V2  Sidebar Right</a></li>
                                        </ul>
                                    </li>

                                    <li><a href="blog-v3.html">Blog Version 3</a>
                                        <ul class="submenu">
                                            <li><a href="blog-v3-left_sidebar.html">Blog V3 Sidebar Left</a></li>
                                            <li><a href="blog-v3-right_sidebar.html">Blog v3 Sidebar Right </a></li>
                                        </ul>
                                    </li>
                            ...
                            <li><a href="contactv1.html">Contact</a>  
                                <ul class="submenu right-sub-menu">
            ...
            <div class="container">
                ...
                <div class="row bond-teammember">
                    <div class="team col-md-3 col-xs-6">
                        <div class="team-img">
                            <img src="images/home/t1.jpg" alt="image">
                        </div>
                        <div class="content">
...
/javascript/bootstrap.min.js"></script>
                                            <script type="text/javascript" src="<?php echo $this->_tpl_vars['TPL_URL']; ?>
/javascript/jquery.easing.js"></script> 
                                            <script type="text/javascript" src="<?php echo $this->_tpl_vars['TPL_URL']; ?>
/javascript/jquery-countTo.js"></script>
                                            <script type="text/javascript" src="<?php echo $this->_tpl_vars['TPL_URL']; ?>
/javascript/imagesloaded.min.js"></script>
                                            <script type="text/javascript" src="<?php echo $this->_tpl_vars['TPL_URL']; ?>
/javascript/jquery.isotope.min.js"></script>
                                            <script type="text/javascript" src="<?php echo $this->_tpl_vars['TPL_URL']; ?>
/javascript/jquery-waypoints.js"></script> 
                                            <script type="text/javascript" src="<?php echo $this->_tpl_vars['TPL_URL']; ?>
/javascript/jquery.cookie.js"></script>
                                            <script type="text/javascript" src="<?php echo $this->_tpl_vars['TPL_URL']; ?>
/javascript/owl.carousel.js"></script> 
                                            <script type="text/javascript" src="<?php echo $this->_tpl_vars['TPL_URL']; ?>
/javascript/parallax.js"></script>
                                            <script src="<?php echo $this->_tpl_vars['TPL_URL']; ?>
/javascript/swiper.min.js"></script>
...
/javascript/jquery-validate.js"></script>
                                            <script type="text/javascript" src="<?php echo $this->_tpl_vars['TPL_URL']; ?>
/javascript/gmap3.min.js"></script>
                                            <script type="text/javascript" src="<?php echo $this->_tpl_vars['TPL_URL']; ?>
/javascript/main.js"></script>

                                            <!-- Revolution Slider -->
                                            <script type="text/javascript" src="<?php echo $this->_tpl_vars['TPL_URL']; ?>
/javascript/jquery.themepunch.tools.min.js"></script>
                                            <script type="text/javascript" src="<?php echo $this->_tpl_vars['TPL_URL']; ?>
/javascript/jquery.themepunch.revolution.min.js"></script>
                                            <script type="text/javascript" src="<?php echo $this->_tpl_vars['TPL_URL']; ?>
/javascript/slider.js"></script>
