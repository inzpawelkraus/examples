...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pl" lang="pl"  {if !$glowna}class="page"{/if}>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{$TPL_URL}/css/main.min.css" />
        ...
        <script type="text/javascript" src="{$TPL_URL}/js/main.min.js"></script>
    ...
    <body>
        ...
        <section class="body">
            {include file=$body}
            {include file="misc/infoDialogBox.html"}
        </section>
        <section class="foot">
            <div class="container">
