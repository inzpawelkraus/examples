<?php /* Smarty version 2.6.13, created on 2017-03-17 13:26:23
         compiled from misc/mapa-strony.html */ ?>
<div id="page-title"><h1><?php echo $this->_tpl_vars['LANG']['_PAGE_SITEMAP']; ?>
</h1></div>
...
?>
		<a class="site1" href="<?php echo $this->_tpl_vars['map'][$this->_sections['m']['index']]['url']; ?>
...
?>
				<a class="site2" href="<?php echo $this->_tpl_vars['map'][$this->_sections['m']['index']]['submenu'][$this->_sections['mm']['index']]['url']; ?>
...
?>
				<a class="site2" href="<?php echo $this->_tpl_vars['aktualnoscimap'][$this->_sections['a']['index']]['url']; ?>
...
?>
				<a class="site2" href="<?php echo $this->_tpl_vars['gallerymap'][$this->_sections['g']['index']]['url']; ?>
