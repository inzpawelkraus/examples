<?php /* Smarty version 2.6.13, created on 2017-04-05 13:28:04
         compiled from banery/pokaz.html */ ?>
<header class="inner" id="header" role="header">
    <div id="header_image" style="background: url(assets/img/about1.jpg) top center no-repeat;">
        <div class="boxed">
...
"><?php echo $this->_tpl_vars['article']['tagi'][$this->_sections['t']['index']]; ?>
                    ...
                    <div class="postnavi">
                        <ul class="nolist">
                            <li><a href="?" rel="Wstecz"><span class="tooltip-s" title="">&lsaquo;</span></a></li>
                            <li></li>
                        </ul>
                    </div>    				    
                </div>
                <div class="two_third">
                    <div class="featured_image">
                        <a rel="prettyPhoto" href="<?php echo $this->_tpl_vars['TPL_URL']; ?>
/assets/img/searching1.jpg" title="Summer outdoors.">
