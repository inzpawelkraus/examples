<?php /* Smarty version 2.6.13, created on 2017-04-20 15:49:04
         compiled from uzytkownicy/edytuj.html */ ?>
<div id="content-header">
    <div id="breadcrumb"> <a href="/admin" title="Panel" class="tip-bottom"><i class="icon-home"></i> Panel</a> <a>Uzytkownicy</a><a class="current">Edycja</a> </div>
    <h1><?php echo $this->_tpl_vars['pageTitle']; ?>
</h1>
</div>
<div class="container-fluid">
    <div class="row-fluid">
        <a class="btn" href="?"><i class="icon-step-backward"></i> Powrót do spisu użytkowników</a></p>
        ...
        <div class="widget-box">
            <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                <h5>Formularz edycji użytkowanika</h5>
            </div>
...
" class="form-horizontal">
                    <div class="control-group span6">
                        ...
                        <div class="controls">
                            <input class="text" type="text" name="login" readonly="" value="<?php echo $this->_tpl_vars['u']['login']; ?>
" size="40" />
                        </div>
                        <label class="control-label">E-mail :</label>
                        <div class="controls">
                            <input class="text" type="text" name="email1" value="<?php echo $this->_tpl_vars['u']['email']; ?>
" size="40" />
                        </div>
...
">
            <table class="special">
                <tr>
                    ...
                    <td><b><?php echo $this->_tpl_vars['u']['login']; ?>
</b></td>			
                </tr><tr>
                    <td><b>E-mail:</b></td>
                    <td><input class="text" type="text" name="email" value="<?php echo $this->_tpl_vars['u']['email']; ?>
" size="40" /></td>			
                </tr>
                <?php if (! $this->_tpl_vars['u']['admin']): ?>
                <tr>
                    <td><b>Zmień hasło:</b></td>
                    <td><input class="text" type="password" name="haslo" value=""  /></td>
                </tr>
                <?php endif; ?>
                ...
                <tr>
                    ...
                    <td>
                        <select name="active">
                            <option value="0"<?php if ($this->_tpl_vars['u']['active'] == 0): ?> selected="true"<?php endif; ?>>nieaktywne</option>
                            <option value="1"<?php if ($this->_tpl_vars['u']['active'] == 1): ?> selected="true"<?php endif; ?>>aktywne</option>
                        </select>				
                    </td>
                </tr><tr>
                    ...
                    <td>
                        <select name="admin_login">
                            <option value="0"<?php if ($this->_tpl_vars['u']['admin_login'] == 0): ?> selected="true"<?php endif; ?>>NIE</option>
                            <option value="1"<?php if ($this->_tpl_vars['u']['admin_login'] == 1): ?> selected="true"<?php endif; ?>>TAK</option>
                        </select>				
                    </td>
                </tr><tr>
                    <td><b>Grupa:</b></td>
...
?>
                            <option value="<?php echo $this->_tpl_vars['groups'][$this->_sections['g']['index']]['id']; ?>
"<?php if ($this->_tpl_vars['groups'][$this->_sections['g']['index']]['id'] == $this->_tpl_vars['u']['group_id']): ?> selected="true"<?php endif; ?>><?php echo $this->_tpl_vars['groups'][$this->_sections['g']['index']]['name']; ?>
</option> 
                            <?php endfor; endif; ?>					
                        </select>				
                    </td>
                    ...
                    <td>
                        <input id="b0" type="radio" name="business" value="0"<?php if ($this->_tpl_vars['u']['business'] == 0): ?> checked="true"<?php endif; ?> />
                               <label for="b0">osoba fizyczna</label><br />
                        <input id="b1" type="radio" name="business" value="1"<?php if ($this->_tpl_vars['u']['business'] == 1): ?> checked="true"<?php endif; ?>  />
                               <label for="b1">firma</label><br />				
                    </td>			
                </tr><tr>
                    <td><b>Nazwa firmy:</b></td>
                    <td><input class="text" type="text" name="firm_name" value="<?php echo $this->_tpl_vars['u']['firm_name']; ?>
" size="40" /></td>			
                </tr><tr>
                    <td><b>Numer NIP:</b></td>
                    <td><input class="text" type="text" name="nip" value="<?php echo $this->_tpl_vars['u']['nip']; ?>
" size="40" /></td>			
                </tr><tr>
                    <td><b>Imię:</b></td>
                    <td><input class="text" type="text" name="first_name" value="<?php echo $this->_tpl_vars['u']['first_name']; ?>
" size="40" /></td>
                </tr><tr>
                    <td><b>Nazwisko:</b></td>
                    <td><input class="text" type="text" name="last_name" value="<?php echo $this->_tpl_vars['u']['last_name']; ?>
" size="40" /></td>			
                </tr><tr>
                    <td><b>Ulica:</b></td>
                    <td><input class="text" type="text" name="street" value="<?php echo $this->_tpl_vars['u']['street']; ?>
" size="40" /></td>		
                </tr><tr>
                    <td><b>Nr budynku/lokalu:</b></td>
                    <td><input class="text" type="text" name="nr_bud" value="<?php echo $this->_tpl_vars['u']['nr_bud']; ?>
" size="15" /> <input class="text" type="text" name="nr_lok" value="<?php echo $this->_tpl_vars['u']['nr_lok']; ?>
" size="15" /></td>		
                </tr><tr>
                    <td><b>Kod pocztowy:</b><br /><small>Poprawny kod pocztowy: xx-xxx</small></td>
                    <td><input class="text" type="text" name="post_code" value="<?php echo $this->_tpl_vars['u']['post_code']; ?>
" size="6" maxlength="6" /></td>			
                </tr><tr>
                    <td><b>Miejscowość:</b></td>
                    <td><input class="text" type="text" name="city" value="<?php echo $this->_tpl_vars['u']['city']; ?>
" size="40" /></td>			
                </tr><tr>
                    <td><b>Telefon:</b></td>
                    <td><input class="text" type="text" name="phone" value="<?php echo $this->_tpl_vars['u']['phone']; ?>
" size="40" /></td>
                </tr><tr>
                    <td></td>
                    <td>
