<?php /* Smarty version 2.6.13, created on 2017-03-22 09:48:30
         compiled from banery/dodaj.html */ ?>
...
" name="content[<?php echo $this->_tpl_vars['JEZYK'][$this->_sections['j4']['index']]['id']; ?>
                    ...
                    <div class="form-actions">
                        <input class="btn btn-success" type="submit" name="action" value="Dodaj baner" />
