<?php /* Smarty version 2.6.13, created on 2017-04-05 12:37:04
         compiled from zmieniarka/pokaz.html */ ?>
...
<div class="container-fluid">
    <div class="row-fluid">
        <a href="?action=add_gallery" title="Nowa galeria" class="btn"><i class="icon-plus"></i>   Dodaj nowy</a>
...
" title="Kasuj">
                ...
                <?php endif; ?>
                <?php endfor; else: ?>
                <tr><td colspan="2">Nie utworzono jeszcze slidera.</td></tr>
                <?php endif; ?>
            </div>
        </div>
    </div>
