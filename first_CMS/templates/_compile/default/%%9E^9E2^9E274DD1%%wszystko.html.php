<?php /* Smarty version 2.6.13, created on 2017-06-06 09:50:26
         compiled from petycje/wszystko.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'petycje/wszystko.html', 18, false),)), $this); ?>
<section class="body page petitions" >
...
" title="Przejdź do petycji: <?php echo $this->_tpl_vars['articles'][$this->_sections['aa']['index']]['title']; ?>
" style="color: #333;">
            <div class="img_container">
                <?php if ($this->_tpl_vars['articles'][$this->_sections['aa']['index']]['photo']['small']): ?>
                <img src="<?php echo $this->_tpl_vars['articles'][$this->_sections['aa']['index']]['photo']['small']; ?>
"/>
                <?php else: ?>
                <img src="<?php echo $this->_tpl_vars['TPL_URL']; ?>
/img/petition1.jpg"/>
                <?php endif; ?>
                <span class="petitionTitle"><?php echo $this->_tpl_vars['articles'][$this->_sections['aa']['index']]['title']; ?>
</span>
                <span class="progress"><spam class="counterBox"><?php echo $this->_tpl_vars['articles'][$this->_sections['aa']['index']]['progress']; ?>
</spam>%</span>
                <span class="info">Zebraliśmy </br><strong class="counterBox"><?php echo $this->_tpl_vars['articles'][$this->_sections['aa']['index']]['comm']; ?>
</strong> </br>podpisów</span>
            </div>
            <div class="content">
                <?php echo ((is_array($_tmp=$this->_tpl_vars['articles'][$this->_sections['aa']['index']]['content_short'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 340, "...", true) : smarty_modifier_truncate($_tmp, 340, "...", true)); ?>

                <a class="more" href="<?php echo $this->_tpl_vars['articles'][$this->_sections['aa']['index']]['url']; ?>
" title="Przejdź do petycji: <?php echo $this->_tpl_vars['articles'][$this->_sections['aa']['index']]['title']; ?>
">Czytaj wiecej</a>
            </div>
        </div>
