<?php /* Smarty version 2.6.13, created on 2017-03-21 22:26:00
         compiled from banery/pokaz.html */ ?>
<div id="content-header">
    <div id="breadcrumb"> <a href="/admin" title="Panel" class="tip-bottom"><i class="icon-home"></i> Panel</a> <a>Banery</a><a class="current">Zarządzanie</a> </div>
...
" title="Kasuj">
                        ...
                        <?php endfor; else: ?>
                        <tr><td colspan="2">Brak banerów w bazie. Aby stworzyć nowy użyj opcji powyżej.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
