<?php /* Smarty version 2.6.13, created on 2017-04-21 13:59:46
         compiled from blog/pokaz.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'blog/pokaz.html', 30, false),)), $this); ?>
<div id="content-header">
    <div id="breadcrumb"> <a href="/admin" title="Panel" class="tip-bottom"><i class="icon-home"></i> Panel</a> <a>Blog</a><a class="current">Zarządzanie</a> </div>
    <h1><?php echo $this->_tpl_vars['pageTitle']; ?>
</h1>
</div>
<div class="container-fluid">
    <div class="row-fluid">
        <a href="?action=add" title="Nowa aktualność" class="btn"><i class="icon-plus"></i>   Dodaj nowy</a>
...
" title="Kasuj">
                        ...
                        <?php endfor; else: ?>
                        <tr><td colspan="5">Brak wpisów w bazie. Aby stworzyć nową artykuł użyj opcji powyżej.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
