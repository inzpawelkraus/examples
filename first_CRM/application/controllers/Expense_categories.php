...
class Expense_categories extends MY_Controller {
    ...
    private function _make_row($data) {
        return array($data->title,
            modal_anchor(get_uri("expense_categories/modal_form"), "<i class='fas fa-pencil-alt'></i>", array("class" => "edit", "title" => lang('edit_expenses_category'), "data-post-id" => $data->id))
