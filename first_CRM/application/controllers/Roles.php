...
class roles extends MY_Controller {
    ...
    private function _make_row($data) {
        return array("<a href='#' data-id='$data->id' class='role-row link'>" . $data->title . "</a>",
            "<a class='edit'><i class='fa fa-check' ></i></a>" . modal_anchor(get_uri("roles/modal_form"), "<i class='fas fa-pencil-alt'></i>", array("class" => "", "title" => lang('edit_role'), "data-post-id" => $data->id))
