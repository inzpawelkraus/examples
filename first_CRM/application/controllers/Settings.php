...
class Settings extends MY_Controller {
    ...
    function save_company_settings() {
        $settings = array("company_name", "company_address", "company_nip_number", "company_phone", "banking", "banking_number", "company_email", "company_website");
    ...
    private function _make_notification_settings_row($data) {
        ...
        return array(
            ...
            modal_anchor(get_uri("settings/notification_modal_form"), "<i class='fas fa-pencil-alt'></i>", array("class" => "edit", "title" => lang('notification'), "data-post-id" => $data->id))
        );
    }
