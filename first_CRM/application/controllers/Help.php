...
class Help extends MY_Controller {
    ...
    private function _make_category_row($data) {
        return array(
            ...
            lang($data->status),
            $data->sort,
            modal_anchor(get_uri("help/category_modal_form/" . $data->type), "<i class='fas fa-pencil-alt'></i>", array("class" => "edit", "title" => lang('edit_category'), "data-post-id" => $data->id))
    ...
    private function _make_article_row($data) {
        return array(
            ...
            lang($data->status),
            $data->total_views,
            anchor(get_uri("help/article_form/" . $data->type . "/" . $data->id), "<i class='fas fa-pencil-alt'></i>", array("class" => "edit", "title" => lang('edit_article')))
