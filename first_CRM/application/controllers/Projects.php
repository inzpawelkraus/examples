...
class Projects extends MY_Controller {
    ...
    private function _make_row($data, $custom_fields) {
        ...
        $optoins = "";
        if ($this->can_edit_projects()) {
            $optoins .= modal_anchor(get_uri("projects/modal_form"), "<i class='fas fa-pencil-alt'></i>", array("class" => "edit", "title" => lang('edit_project'), "data-post-id" => $data->id));
        }
    ...
    private function _make_timesheet_row($data) {
        ...
        return array(
            ...
            $note_link,
            modal_anchor(get_uri("projects/timelog_modal_form"), "<i class='fas fa-pencil-alt'></i>", array("class" => "edit", "title" => lang('edit_timelog'), "data-post-id" => $data->id))
    ...
    private function _make_milestone_row($data) {
        ...
        $optoins = "";
        if ($this->can_edit_milestones()) {
            $optoins .= modal_anchor(get_uri("projects/milestone_modal_form"), "<i class='fas fa-pencil-alt'></i>", array("class" => "edit", "title" => lang('edit_milestone'), "data-post-id" => $data->id));
        }
    ...
    private function _make_task_row($data, $custom_fields) {
        ...
        $options = "";
        if ($this->can_edit_tasks()) {
            $options .= modal_anchor(get_uri("projects/task_modal_form"), "<i class='fas fa-pencil-alt'></i>", array("class" => "edit", "title" => lang('edit_task'), "data-post-id" => $data->id));
        }
        if ($this->can_delete_tasks()) {
