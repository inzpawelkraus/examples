...
class Payment_methods extends MY_Controller {
    ...
    private function _make_row($data) {
        $options = modal_anchor(get_uri("payment_methods/modal_form"), "<i class='fas fa-pencil-alt'></i>", array("class" => "edit", "title" => lang('edit_payment_method'), "data-post-id" => $data->id));
