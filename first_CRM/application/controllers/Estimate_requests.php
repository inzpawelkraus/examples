...
class Estimate_requests extends MY_Controller {
    ...
    private function _make_form_row($data) {
        ...
        return array(
            ...
            $public,
            lang($data->status),
            modal_anchor(get_uri("estimate_requests/estimate_request_modal_form"), "<i class='fas fa-pencil-alt'></i>", array("class" => "edit", "title" => lang('edit_form'), "data-post-id" => $data->id))
    ...
    private function _make_form_field_row($data) {
        ...
        return array(
            $field,
            $data->sort,
            modal_anchor(get_uri("estimate_requests/estimate_form_field_modal_form/" . $estimate_form_id), "<i class='fas fa-pencil-alt'></i>", array("class" => "edit", "title" => lang('edit_form'), "data-post-id" => $data->id))
