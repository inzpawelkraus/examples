...
class Estimates extends MY_Controller {
    ...
    private function _make_row($data) {
        ...
        return array(
            ...
            modal_anchor(get_uri("estimates/modal_form"), "<i class='fas fa-pencil-alt'></i>", array("class" => "edit", "title" => lang('edit_estimate'), "data-post-id" => $data->id))
    ...
    private function _make_item_row($data) {
        ...
        return array(
            ...
            modal_anchor(get_uri("estimates/item_modal_form"), "<i class='fas fa-pencil-alt'></i>", array("class" => "edit", "title" => lang('edit_estimate'), "data-post-id" => $data->id))
