<div class="row">
    ...
    <div class="col-lg-12">
        <section class="panel panel-default">
            <header class="panel-heading"> <i class="fas fa-pencil-alt"></i> <?=lang('project_settings')?> - <span class="text-danger"><?php echo Project::by_id($project_id)->project_title; ?></span></header>
            <!-- Start Settings -->
