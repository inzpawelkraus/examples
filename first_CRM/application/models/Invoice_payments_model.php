...
class Invoice_payments_model extends Crud_model {
    ...
    function get_details($options = array()) {
        ...
        $sql = "SELECT $invoice_payments_table.*, $invoices_table.number, $invoices_table.client_id, (SELECT $clients_table.currency_symbol FROM $clients_table WHERE $clients_table.id=$invoices_table.client_id limit 1) AS currency_symbol, $payment_methods_table.title AS payment_method_title
