...
<div class="modal-footer">
    ...
    if (isset($editable) && $editable === "1" && ($this->login_user->id == $model_info->created_by || $this->login_user->is_admin)) {
        ...
        echo modal_anchor(get_uri("events/modal_form/"), "<i class='fas fa-pencil-alt'></i> " . lang('edit_event'), array("class" => "btn btn-default", "data-post-encrypted_event_id" => $encrypted_event_id, "title" => lang('edit_event')));
    }
    ?>
