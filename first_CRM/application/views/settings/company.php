    ...
    <div class="col-sm-9 col-lg-10">
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="company_nip_number" class=" col-md-2"><?php echo lang('nip'); ?></label>
                    <div class=" col-md-10">
                        <?php
                        echo form_input(array(
                            "id" => "company_nip_number",
                            "name" => "company_nip_number",
                            "value" => get_setting("company_nip_number"),
                            "class" => "form-control",
                ...
                <div class="form-group">
                    <label for="banking" class=" col-md-2"><?php echo lang('banking'); ?></label>
                    <div class=" col-md-10">
                        <?php
                        echo form_input(array(
                            "id" => "banking",
                            "name" => "banking",
                            "value" => get_setting("banking"),
                            "class" => "form-control",
                            "placeholder" => lang('banking')
                        ));
                        ?>
                    </div>
                </div>
                <div class="form-group">
                    <label for="banking_number" class=" col-md-2"><?php echo lang('banking_number'); ?></label>
                    <div class=" col-md-10">
                        <?php
                        echo form_input(array(
                            "id" => "banking_number",
                            "name" => "banking_number",
                            "value" => get_setting("banking_number"),
                            "class" => "form-control",
                            "placeholder" => lang('banking_number')
                        ));
                        ?>
                    </div>
                </div>
