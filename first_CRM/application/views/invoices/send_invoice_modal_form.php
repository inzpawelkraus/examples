...
<div class="modal-body clearfix">
    ...
    <div class="form-group ml15">
        <i class='fa fa-check-circle' style="color: #5CB85C;"></i> <?php echo lang('attached') . ' ' . anchor(get_uri("invoices/download_pdf/" . $invoice_info->id), lang("invoice") . "-#$invoice_info->number.pdf", array("target" => "_blank")); ?>
    </div>
