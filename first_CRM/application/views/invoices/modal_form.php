...
<div class="modal-body clearfix">
    ...
    <div class="form-group">
        ...
        <label for="invoice_realization_date" class=" col-md-3"><?php echo lang('realization_date'); ?></label>
        <div class="col-md-9">
            <?php
            echo form_input(array(
                "id" => "invoice_realization_date",
                "name" => "invoice_realization_date",
                "value" => $model_info->realization_date,
                "class" => "form-control recurring_element",
                "placeholder" => lang('realization_date'),
                "data-rule-required" => true,
                "data-msg-required" => lang("field_required"),
            ));
            ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        setDatePicker("#invoice_bill_date, #invoice_realization_date, #invoice_due_date");
