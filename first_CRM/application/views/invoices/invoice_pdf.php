...
<table style="width: 100%; color: #444;">
    <tr>
        <td width="50">&nbsp;</td>
        <td align="center" style="border-top: 1px dotted #000000; font-size: 8px;">
            <?php echo lang('invoice_contractor_left'); ?>
        </td>
        <td width="330">&nbsp;</td>
        <td align="center" style="border-top: 1px dotted #000000; font-size: 8px;">
            <?php echo lang('invoice_contractor_right'); ?>
        </td>
        <td width=""><td width="50"></td></td>
    </tr>
</table>
