<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
    ...
    <div id="navbar" class="navbar-collapse collapse">
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="">
                <?php echo js_anchor("<i class='fa fal fa-bell'></i>", array("id" => "web-notification-icon", "class" => "dropdown-toggle", "data-toggle" => "dropdown")); ?>
            ...
            <li class="dropdown pr15 dropdown-user">
                ...
                <ul class="dropdown-menu p0" role="menu">
                    ...
                    <?php } ?>
                    <?php if ($this->login_user->user_type == "xdxd") { ?>
                        <li class="divider"></li>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        notificationOptions.icon = "fa fal fa-bell";
