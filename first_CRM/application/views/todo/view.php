...
<div class="modal-footer">
    <?php
    echo modal_anchor(get_uri("todo/modal_form/"), "<i class='fas fa-pencil-alt'></i> " . lang('edit'), array("class" => "btn btn-default", "data-post-id" => $model_info->id, "title" => lang('edit')));
    ?>
