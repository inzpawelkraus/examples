...
<div class="modal-footer">
    <?php
    echo modal_anchor(get_uri("notes/modal_form/"), "<i class='fas fa-pencil-alt'></i> " . lang('edit_note'), array("class" => "btn btn-default", "data-post-id" => $model_info->id, "title" => lang('edit_note')));
    ?>
