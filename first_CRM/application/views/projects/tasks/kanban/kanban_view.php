        ...
        <ul id="kanban-container" class="kanban-container clearfix" style="width: <?php echo $column_width; ?>px;">
            ...
            <?php foreach ($columns as $column) { ?>
                <li class="kanban-col" >
                    ...
                    <div  id="kanban-item-list-<?php echo $column->id; ?>" class="kanban-item-list" data-status_id="<?php echo $column->id; ?>" data-status="<?php echo $column->key_name; ?>">
...
<script type="text/javascript">
    ...
    saveStatusAndSort = function ($item, status, status_name) {
        appLoader.show();
        ...
        $.ajax({
            ...
            type: "POST",
            data: {id: id, sort: newSort, status_id: status, status: status_name, project_id: project_id},
            success: function () {
                appLoader.hide();
                //location.reload();
            }
        ...
        $(".kanban-item-list").each(function (index) {
            ...
            var options = {
                ...
                onAdd: function (e) {
                    ...
                    saveStatusAndSort($(e.item), $(e.item).closest(".kanban-item-list").attr("data-status_id"), $(e.item).closest(".kanban-item-list").attr("data-status"));
                },
                onUpdate: function (e) {
                    //updated sort
