        ...
        <div class="col-md-12">
                    ...
                    <?php if ($show_actions_dropdown) { ?>
                        <span class="dropdown inline-block">
                            ...
                            <ul class="dropdown-menu dropdown-left" role="menu">
                                ...
                                echo "<li role='presentation'>" . modal_anchor(get_uri("projects/modal_form"), "<i class='fas fa-pencil-alt'></i> " . lang('edit_project'), array("class" => "edit", "title" => lang('edit_project'), "data-post-id" => $project_info->id)) . " </li>";
                                ?>
            ...
            <ul id="project-tabs" data-toggle="ajax-tab" class="nav nav-tabs classic" role="tablist">
                <?php if ($this->login_user->user_type === "staff") { ?>
                    ...
                    <li><a role="presentation" href="<?php echo_uri("projects/tasks_kanban/" . $project_info->id); ?>" data-target="#project-tasks-kanban-section"><?php echo lang("kanban"); ?></a></li>
